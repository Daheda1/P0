...
def test_get_terrain(folder_path):
    ...
    for terrain_type in os.listdir(folder_path):
        ...
        if os.path.isdir(terrain_folder):
            ...
            for tile_file in os.listdir(terrain_folder):
                ...
                # Bruger 'cv.imread' til at indlæse 'tile_path' og definerer det som 'tile'.
                ...
                # Hvis både 'terrain_type' og 'predicted_terrain' findes i 'DataFrame's index og kolonner,
                # så tillæges cellens værdi 1.
    ...
    # Beregner accuracy for en given terrain_type og printer svaret som en text. 
    ...
    # Fylder tomme felter i confusion_matrix med 0 og sikrer at hele matrixen er i heltal. 
